...
export default function UserNetwork() {
  ...
  return (
    <main className="wrap fadein" style={{ paddingTop: 40, minHeight: '72vh' }}>
      ...
      <p style={{ maxWidth: 700, marginTop: 12, fontSize: 17, fontWeight: 600, lineHeight: 1.5, color: 'var(--text)' }}>
        Upload a CSV and EtioMap draws the corresponding chemical–disease network from your data. Two formats work:
      </p>
      <ul className="muted" style={{ maxWidth: 700, fontSize: 14.5, lineHeight: 1.8, paddingLeft: 20 }}>
        <li><b>Association list</b>: columns for a <span className="mono">chemical</span> and a <span className="mono">disease</span> (optional <span className="mono">weight</span> / <span className="mono">link_type</span>). It is drawn exactly as given.</li>
        <li><b>Compound list</b>: just a <span className="mono">chemical</span> column. Each compound is resolved on PubChem and scored by the model against the six diseases. Edges are <b>predictions</b> above the likelihood threshold you choose.</li>
      </ul>
